    ...
    <div className='flex flex-col'>
      ...
      <div className='flex flex-col items-center mt-[60px]'>
        ...
        <Link href='/session'
          ...
          className=" cursor-pointer bg-[#9ACC8F] hover:bg-[#aad2a2] font-no-name-regular text-[19px] text-[#56710C]  flex items-center justify-center mt-[70px] mb-[120px] rounded-[2000px] w-[180px] h-[60px] hover:scale-105 active:scale-100"
        >
          {t('play')}
        </Link>
      </div>
