...
const copy = {
  en: {
    headline: "Less mind clutter, more peace of mind",
    subheadline: "Ten minutes. One thought. A guided way to examine stressful thoughts.",
  },
  nl: {
    headline: "Minder mind clutter, meer rust in je hoofd",
    subheadline: "Tien minuten. Een gedachte. Een begeleide manier om stressvolle gedachten te onderzoeken.",
  },
} as const;
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", width: "58vw" }}>
              <div style={{ fontSize: 60, fontWeight: 700, marginBottom: "120px", fontFamily: "NoName",marginLeft: "60px", lineHeight: 1.05 }}>
                {content.headline}
              </div>
            </div>
          </div>
