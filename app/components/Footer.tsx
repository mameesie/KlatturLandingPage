...
function Footer() {
  ...
  return (
    ...
    <div className='shrink-0 mt-auto bg-[#254c5c] text-white font-no-name-regular flex flex-col text-center justify-center leading-[30px] text-[14px] h-[160px] px-[20px]' >
